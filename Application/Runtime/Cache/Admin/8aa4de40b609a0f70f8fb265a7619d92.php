...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- /.row -->
        <form action="<?php echo U('saveresult',array('id'=>$arr1[id]));?>" method="post" enctype="multipart/form-data">
            <div class="row">

                <div class="col-lg-3">
                    <label class="control-label">成果标题</label>
                    <input type="text" placeholder="标题" name='title' class="form-control" value="<?php echo ($arr1["title"]); ?>"></div>
                <div class="col-lg-6">
...
<!-- <script type="text/javascript">var ue = UE.getEditor('container');</script>
 ...
 <script>
     $("option[value=<?=$arr1[class_id]?>]").attr('selected','selected');
 </script>
</div>
    <!-- /#wrapper -->
